...
class NotificationServiceTest {
  ...
  class FindUnconfirmed {
    ...
    void limit이_null이면_DEFAULT_LIMIT으로_조회한다() {
      // given
      NotificationSearchRequest request = new NotificationSearchRequest(null, null, null);
    ...
    void limit이_지정되면_해당_값으로_조회한다() {
      // given
      NotificationSearchRequest request = new NotificationSearchRequest(null, null, 10);
    ...
    void 다음_페이지가_있으면_hasNext_true로_mapper를_호출한다() {
      // given
      int limit = 2;
      NotificationSearchRequest request = new NotificationSearchRequest(null, null, limit);
